...
if __name__ == "__main__":
    ...
    # draw the loss function (used for exploration of the effect of different parameters during parameter tuning)
    #agent.draw_loss(agent.episode, agent.total_losses)

    # draw the reward function (used for exploration of the effect of different parameters during parameter tuning)
    #agent.draw_rewards(agent.repisode, agent.rewards)
